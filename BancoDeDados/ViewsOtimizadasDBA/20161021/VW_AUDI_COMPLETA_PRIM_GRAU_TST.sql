-- Não é possível renderizar a DLL VIEW para o objeto PROJUDI.VW_AUDI_COMPLETA_PRIM_GRAU_TST com o DBMS_METADATA tentando um gerador interno.
CREATE VIEW VW_AUDI_COMPLETA_PRIM_GRAU_TST
...
UNION ALL
  ...
  */COMMENT ON TABLE VW_AUDI_COMPLETA_PRIM_GRAU_TST IS 'View que deverá substituir a VIEW_AUDI_COMPLETA_PRIM_GRAU, após a validação por parte da DSI (Márcio/Jesus). Att.: Kellyton C. Feitosa - 12/09/2016 10:34.'
