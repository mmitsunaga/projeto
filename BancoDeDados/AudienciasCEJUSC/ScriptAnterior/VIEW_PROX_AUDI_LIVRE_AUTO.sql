-- Não é possível renderizar a DLL VIEW para o objeto PROJUDI.VIEW_PROX_AUDI_LIVRE_AUTO com o DBMS_METADATA tentando um gerador interno.
CREATE VIEW PROJUDI.VIEW_PROX_AUDI_LIVRE_AUTO
AS SELECT 
