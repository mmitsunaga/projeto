...
ATENCAO: SQL EXECUTADO EM PRODUCAO DIA 10/02/2021

//********************
CREATE OR REPLACE VIEW VIEW_GUIA_EMIS
AS SELECT
...
ALTER TABLE PROJUDI.GUIA_EMIS drop column "ASSUNTOS";
ALTER TABLE PROJUDI.GUIA_EMIS drop column "FLAG_DONO";
ALTER TABLE PROJUDI.GUIA_EMIS drop column "ADVOGADO";
ALTER TABLE PROJUDI.GUIA_EMIS drop column "OUTRAS_PARTES";
ALTER TABLE PROJUDI.GUIA_EMIS drop column "GUIA_EMIS_CODIGO";
commit;