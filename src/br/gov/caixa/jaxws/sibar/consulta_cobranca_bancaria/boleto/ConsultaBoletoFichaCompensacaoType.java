...
/**
 * <p>Java class for consulta_boleto_ficha_compensacao_Type complex type.
 * 
...
public class ConsultaBoletoFichaCompensacaoType {

    @XmlElement(name = "MENSAGENS", required = true)
    protected ConsultaBoletoMensagensFichaCompensacaoType mensagens;
     ...
     * @return
     *     possible object is
     *     {@link ConsultaBoletoMensagensFichaCompensacaoType }
     *     
     */
    public ConsultaBoletoMensagensFichaCompensacaoType getMENSAGENS() {
        return mensagens;
    }
     ...
     *     
     */
    public void setMENSAGENS(ConsultaBoletoMensagensFichaCompensacaoType value) {
