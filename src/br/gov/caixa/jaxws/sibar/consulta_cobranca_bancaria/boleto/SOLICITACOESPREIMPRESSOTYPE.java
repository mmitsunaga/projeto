...
/**
 * <p>Java class for SOLICITACOES_PRE_IMPRESSO_TYPE complex type.
 * 
...
public class SOLICITACOESPREIMPRESSOTYPE {

    @XmlElement(name = "SOLICITACAO")
    protected List<SOLICITACAOPREIMPRESSOTYPE> solicitacao;
     ...
     * {@link SOLICITACAOPREIMPRESSOTYPE }
     * 
     * 
     */
    public List<SOLICITACAOPREIMPRESSOTYPE> getSOLICITACAO() {
        if (solicitacao == null) {
            solicitacao = new ArrayList<SOLICITACAOPREIMPRESSOTYPE>();
        }
