...
public class EmissaoBoletoCt extends Controle {

	private static final long serialVersionUID = -1804822061775298448L;

	private static final String PAGINA_EMISSAO_BOLETO 	     = "/WEB-INF/jsptjgo/EmissaoBoleto.jsp";
	...
	public void executar(HttpServletRequest request, HttpServletResponse response, UsuarioNe UsuarioSessao, int paginaatual, String tempNomeBusca, String PosicaoPaginaAtual) throws Exception, ServletException, IOException {
		...
		String stAcao 		= PAGINA_EMISSAO_BOLETO;
		int passoEditar 	= -1;
		...
		if( request.getParameter("numeroGuiaCompleto") != null ) {
			...
			numeroGuiaInformado = numeroGuiaInformado.trim().replace("/", "");
			numeroGuiaInformado = numeroGuiaInformado.trim().replace("-", "");
			numeroGuiaInformado = numeroGuiaInformado.trim().replace(" ", "");
		}
	...
	private boolean MostraDetalhesDaGuia(HttpServletRequest request) throws Exception
	{
		GuiaEmissaoNe GuiaEmissaone = new GuiaEmissaoNe();
