...
import br.gov.go.tj.projudi.ct.GuiaConciliacaoCt;
...
public class GuiaConciliacaoPublicaCt extends GuiaConciliacaoCt {
	...
	protected String obtenhaTituloPagina() {
		return "Guia de Conciliação [Acesso Público]";
	}
	
	@Override
	protected String obtenhaAcaoMensagemOk(ProcessoDt processoDt, String mensagem) {
		return "GuiaConciliacaoPublica?PaginaAtual="+Configuracao.Novo+"&MensagemOk="+mensagem;
	}
	
	@Override
	protected String obtenhaAcaoMensagemErro(ProcessoDt processoDt, String mensagem) {
		return "GuiaConciliacaoPublica?PaginaAtual="+Configuracao.Novo+"&MensagemErro="+mensagem;
	}
