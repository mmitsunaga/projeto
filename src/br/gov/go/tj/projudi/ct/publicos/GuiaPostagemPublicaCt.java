...
import br.gov.go.tj.projudi.ct.GuiaPostagemCt;
...
public class GuiaPostagemPublicaCt extends GuiaPostagemCt {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1212318397770093268L;
	...
	protected String obtenhaTituloPagina() {
		return "Guia de Postagem [Acesso Público]";
	}
	
	@Override
	protected String obtenhaAcaoMensagemOk(ProcessoDt processoDt, String mensagem) {
		return "GuiaPostagemPublica?PaginaAtual="+Configuracao.Novo+"&MensagemOk="+mensagem;
	}
	
	@Override
	protected String obtenhaAcaoMensagemErro(ProcessoDt processoDt, String mensagem) {
		return "GuiaPostagemPublica?PaginaAtual="+Configuracao.Novo+"&MensagemErro="+mensagem;
	}
