...
/**
 * Controlador responsável em gerar o PDF de uma lista de publicações de uma data específica.
 * @author mmitsunaga
 * 
 * PublicacaoPdf?PaginaAtual=2 - Faz a geração do pdf com as publicações
 * PublicacaoPdf?PaginaAtual=2&PassoEditar=1 - Consulta o status da geração. Flag=1, fechar dialogo ajax
 * 
 */
public class PublicacaoPDFCt extends Controle {
	...
	private String montarMensagemNaoEncontradoException(String dataPublicacao, int opcaoPublicacao){
		...
		msg.append("Não foram encontradas publicações");
