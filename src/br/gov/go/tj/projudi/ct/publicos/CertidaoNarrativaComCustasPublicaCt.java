...
import br.gov.go.tj.projudi.ct.GuiaCertidaoNarrativaCt;
...
public class CertidaoNarrativaComCustasPublicaCt extends GuiaCertidaoNarrativaCt {
	
	private static final long serialVersionUID = -4272376968361236393L;
	...
	public void executar(HttpServletRequest request, HttpServletResponse response, UsuarioNe UsuarioSessao, int paginaatual, String nomebusca, String posicaopaginaatual) throws Exception, ServletException, IOException {
		...
		switch (paginaatual) {
			...
			case Configuracao.Curinga9:
				super.redireciona(response, "CertidaoGuia?PaginaAtual=" + Configuracao.Novo + "&ServletRedirect=" + obtenhaServletDeRetornoPesquisa() + "&TituloDaPagina=" + obtenhaTituloPagina());
				return;					
	    }
	...
	protected String obtenhaServletDeRetornoPesquisa() {
		return "CertidaoNarrativaComCustasPublica";
	}
	
	@Override
	protected String obtenhaTituloPagina() {
		return "Certidão Narrativa com Custas [Acesso Público]";
	}
	 
	@Override
	protected String obtenhaAcaoMensagemOk(ProcessoDt processoDt, String mensagem) {
		return "CertidaoNarrativaComCustasPublica?PaginaAtual="+Configuracao.Novo+"&MensagemOk="+mensagem;
	}
	
	@Override
	protected String obtenhaAcaoMensagemErro(ProcessoDt processoDt, String mensagem) {
		return "CertidaoNarrativaComCustasPublica?PaginaAtual="+Configuracao.Novo+"&MensagemErro="+mensagem;
	}
