...
public class GuiaCertidaoNarrativaPublicaCt extends GuiaCertidaoNarrativaCt {
	...
	protected String obtenhaServletDeRetornoPesquisa() {
		return "GuiaCertidaoNarrativaPublica";
	}
	...
	protected String obtenhaTituloPagina() {
		return "Guia de Certidão Narrativa [Acesso Público]";
	}
	 
	@Override
	protected String obtenhaAcaoMensagemOk(ProcessoDt processoDt, String mensagem) {
		return "GuiaCertidaoNarrativaPublica?PaginaAtual="+Configuracao.Novo+"&MensagemOk="+mensagem;
	}
	
	@Override
	protected String obtenhaAcaoMensagemErro(ProcessoDt processoDt, String mensagem) {
		return "GuiaCertidaoNarrativaPublica?PaginaAtual="+Configuracao.Novo+"&MensagemErro="+mensagem;
	}
