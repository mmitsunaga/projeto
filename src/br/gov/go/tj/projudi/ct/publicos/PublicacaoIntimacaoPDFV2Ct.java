 ...
 */
public class PublicacaoIntimacaoPDFV2Ct extends Controle {
	...
	public void executar(HttpServletRequest request, HttpServletResponse response, UsuarioNe UsuarioSessao, int paginaatual, String nomebusca, String posicaopaginaatual) throws Exception, ServletException, IOException {
		...
		request.setAttribute("tempPrograma", "IntimacaoPDFv2");
		request.setAttribute("tempRetorno", "IntimacaoPDFv2");
			...
			case Configuracao.Localizar:
				if (passoEditar == 1){
			        ...
			        if (!dataPublicacao.isEmpty()){
			    		...
			    		List<MovimentacaoIntimacaoDt> intimacoes = pendenciaNe.consultarIntimacoesParaPublicacaoV2(dataInicial, dataFinal, opcaoPublicacao);
