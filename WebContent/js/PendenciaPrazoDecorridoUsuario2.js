function buscaDados(posicao, tamanho) {
	...
	url = 'PendenciaDwr?AJAX=ajax&PaginaAtual=3&fluxo=10&Id_PendenciaTipo='+document.getElementById('Id_PendenciaTipo').value+'&PosicaoPaginaAtual=' + posicao;
    $.ajax({
        url: url,
        ...
        success: function(retorno){
            ...
            $.each(retorno, function(i,item){
            	if (i > -1){
    				...
    				corpoTabela +='<td>';
    				corpoTabela +='<a href=\"Pendencia?PaginaAtual=7&amp;pendencia=' + item.id + '&amp;CodigoPendencia='+ item.hash +'&amp;fluxo=3&amp;op=PrazoDecorrido\">';
