function buscaDados(posicao, tamanho) {
	...
	url = 'PendenciaDwr?AJAX=ajax&PaginaAtual=3&fluxo=5&Id_PendenciaTipo='+document.getElementById('Id_PendenciaTipo').value+'&PosicaoPaginaAtual=' + posicao;
        ...
        success: function(retorno){
            ...
            $.each(retorno, function(i,item){
            	if (i > -1){
    				...
    				corpoTabela +='<td>';
    				corpoTabela +='<a href=\"Pendencia?PaginaAtual=6&amp;pendencia=' + item.id + '&amp;CodigoPendencia='+ item.hash +'&amp;fluxo=4&amp;op=PrazoDecorrido\">';
