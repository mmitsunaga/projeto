function buscaDados(posicao, tamanho) {
	...
	url = 'PendenciaDwr?AJAX=ajax&PaginaAtual=3&fluxo=4&dataInicialInicio='+document.getElementById('dataInicialInicio').value+'&dataFinalInicio='+document.getElementById('dataFinalInicio').value+'&Id_PendenciaTipo='+document.getElementById('Id_PendenciaTipo').value+'&Id_PendenciaStatus='+document.getElementById('Id_PendenciaStatus').value+'&prioridade='+true+'&filtroTipo='+Formulario.filtroTipo.value+'&PosicaoPaginaAtual=' + posicao;
        ...
        success: function(retorno){
            ...
            $.each(retorno, function(i,item){
            	if (i > -1){
    				...
    				corpoTabela +='<a href="BuscaProcesso?Id_Processo=' + item.desc7 + '">' + item.desc1 + '</a></td>';
    				...
    				corpoTabela +='<td>';
    				corpoTabela +='<a href=\"Pendencia?PaginaAtual=6&amp;pendencia=' + item.id + '&amp;CodigoPendencia='+ item.hash +'&amp;fluxo=4\">';
