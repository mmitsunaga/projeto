							...
							<tr>
								...
								<td class="colunaMinima">
									...
									<%} else { %>
											...
											<%	if ((listaPendencia.getTitulo() != null) && listaPendencia.getTitulo().equals("Elaboração de Voto")) {%>
					...
					<%
						...
						%>
							<tr>
								...
								<%if ((usuario.isAssistenteGabinete()) || usuario.getId_UsuarioServentiaChefe() == null || usuario.getId_UsuarioServentiaChefe().equals("")) {%>								
									<td class="colunaMinima">
