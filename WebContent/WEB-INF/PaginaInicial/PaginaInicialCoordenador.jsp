										...
										while (itPendenciasAndamento.hasNext()){
											...
											<tr >
												...
												<td width="130" align="center">
													<a title="Número: <%=pendenciaDt.getProcessoNumeroCompleto()%> - Classe: <%=pendenciaDt.getProcessoTipo() %>" href="BuscaProcesso?Id_Processo=<%=pendenciaDt.getId_Processo()%>"><%=pendenciaDt.getProcessoNumero()%></a>
												</td>
												...
												<%} else if (Funcoes.StringToInt(usuario.getGrupoTipoCodigo()) == GrupoTipoDt.COORDENADOR_PROCURADORIA
																...
																|| Funcoes.StringToInt(usuario.getGrupoTipoCodigo()) == GrupoTipoDt.COORDENADOR_DEFENSORIA_PUBLICA) {%>
												<td  width="40" align="center">
													<a href="PendenciaUsuarioServentiaResponsavel?PaginaAtual=<%=Configuracao.Novo%>&amp;pendencia=<%=pendenciaDt.getId()%>&amp;CodigoPendencia=<%=pendenciaDt.getHash()%>">
														<img src="imagens/22x22/btn_encaminhar.png"  title="Efetuar troca de responsável da Pendência." />
													</a> 
												</td>
												<%} %>
												<td  width="40" align="center">
													<a href="PendenciaUsuarioServentiaResponsavel?PaginaAtual=<%=Configuracao.Curinga6%>&amp;pendencia=<%=pendenciaDt.getId()%>&amp;CodigoPendencia=<%=pendenciaDt.getHash()%>">
														<img src="imagens/22x22/btn_excluir_2.png" alt="Retirar da Página Inicial" title="Retirar Pendência da Página Inicial" />
													</a> 
												</td>
