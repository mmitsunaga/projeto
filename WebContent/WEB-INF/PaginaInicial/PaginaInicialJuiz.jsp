				...
				<table class="Tabela">
					...
					<tbody>
						...
						<tr>
							...
							<td class="colunaMinima">
								<strong>   
									<a title="Assinar todas conclusões" href="<%= (contNaoAssinadas>0?"AssinarConclusao?PaginaAtual=" + Configuracao.Localizar + "&amp;tipo=":"#")%>">
									  <%=contNaoAssinadas%>							
									</a>
						...
						%>
							<tr>
								...
								<td class="colunaMinima">
									...
									<%} else if (listaPendencia.getTitulo().equals("Elaboração de Voto")) {%>
						...
						<table class="Tabela">
							<thead>
								<tr>
									...
									<th width="20%"> Texto Acórdão / Ementa </th>
								</tr>
							</thead>
							<tbody>
								<tr>
