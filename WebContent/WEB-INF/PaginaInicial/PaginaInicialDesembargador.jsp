			...
			<fieldset class="fieldEdicaoEscuro">
				...
				<table class="Tabela">
					...
					<%					 						
						...
						int contVotoAguardandoAssinatura = 0;
						...
						while (itConclusoesVotoVencido.hasNext()){
								...
								contVotoAguardandoAssinatura += listaConclusaoVoto.getQtdePreAnalisadasPendentesAssinatura();
						%>
							<tr>
						...
						<tr>
							<td align="right">Total</td>
							<td class="colunaMinima"><strong><%=contVotoAguardandoAssinatura%></strong></td>
							<td class="colunaMinima"><strong><%=contVotoNaoAnalisados%></strong></td>
							<td class="colunaMinima"><strong><%=contVotoPreAnalisadas%></strong></td>
						</tr>						
					</tbody>								
				</table>			
			</fieldset>
