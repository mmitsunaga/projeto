		...
		<div id="divCorpo" class="divCorpo">
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao" id="fieldsetServentia" > 
					...
					<input id="Id_Serventia" name="Id_Serventia" type="hidden" value="<%=RelatorioPonteiroDistribuicaodt.getIdServentia()%>"/>
					<input class="formEdicaoInputSomenteLeitura" id="Serventia" name="Serventia" readonly="true" type="text" size="60" maxlength="60" value="<%=RelatorioPonteiroDistribuicaodt.getServentia()%>"/><br />
				</fieldset>  	
				...
				<fieldset class="formEdicao"> 
					...
					<input type="radio" name="Tipo_Relatorio" id="Tipo_Relatorio" value="3" checked="true"/>Situação do Ponteiro 
				    <input type="radio" name="Tipo_Relatorio" id="Tipo_Relatorio" value="8"/>Acompanhar Situação do Ponteiro
				    <input type="radio" name="Tipo_Relatorio" id="Tipo_Relatorio" value="4"/>Listar Processos Distribuídos
				    <input type="radio" name="Tipo_Relatorio" id="Tipo_Relatorio" value="7"/>Acompanhar Processos Distribuídos  
			    </fieldset>
