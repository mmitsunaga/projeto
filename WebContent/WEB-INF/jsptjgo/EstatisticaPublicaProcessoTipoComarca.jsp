...
<html>
	...
	<body>
		<div id="divCorpo" class="divCorpo" >
			...
			<!-- INÍCIO DA ESTATISTICA GERAL DE PROCESSOS DO ESTADO ORGANIZADO POR TIPO DE PROCESSO-->
			<div id="divTabela" class="divTabela"> 
				<table id="Tabela" class="Tabela" width="50%">
					<thead>
						<tr>
							<th colspan="6">ESTATISTICA GERAL DE PROCESSOS DO ESTADO ORGANIZADO POR TIPO DE PROCESSO</th>
						</tr>
						<tr>
							<th class="5%">&nbsp;</th>
							<th width="20%">&nbsp;</th>
			...
			<!-- FIM DA ESTATISTICA GERAL DE PROCESSOS DO ESTADO ORGANIZADO POR TIPO DE PROCESSO -->
			
			<br/><br/>
			
			<tr>
				<td>
				<a>Para visualizar a estatística das Serventias, clique no nome da sua respectiva Comarca.</a>
				</td>
			</tr>
			<br/>
			
			<!-- INÍCIO DA ESTATISTICA GERAL DE PROCESSOS POR COMARCA DO ESTADO ORGANIZADO POR TIPO DE PROCESSO -->
			<div id="divTabela" class="divTabela"> 
				<table id="Tabela" class="Tabela" width="50%">
					<thead>
						<tr>
							<th colspan="6">ESTATISTICA GERAL DE PROCESSOS POR COMARCA DO ESTADO ORGANIZADO POR TIPO DE PROCESSO</th>
						</tr>
						<tr>
							<th class="5%">&nbsp;</th>
							<th width="20%">&nbsp;</th>
					...
					<tbody id="tabListaComarca">
					<%
	  				List liTemp = EstatisticaPublicadt.getListaProcessosGeralComarca();
	  				...
	  				if(liTemp!=null){ 
		  				for(int i = 0 ; i< liTemp.size();i++) {
		  					...
		  					<tr class="TabelaLinha<%=(boLinha?1:2)%>">
								<th colspan="6"><a href="EstatisticaPublica?PassoBusca=2&EstatisticaPublicaTipoConsulta=2&Id_Comarca=<%= objTemp.get("Id_Comarca")%>"><%= objTemp.get("Comarca")%></a></th>
							</tr>
							<%
							boLinha = !boLinha;
							%>
			...
			<!-- FIM DA ESTATISTICA GERAL DE PROCESSOS POR COMARCA DO ESTADO ORGANIZADO POR TIPO DE PROCESSO -->
