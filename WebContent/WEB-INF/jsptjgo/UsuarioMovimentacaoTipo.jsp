...
<head>
	...
	<title> Parametrização de Tipos de Movimentação por Usuário e Grupo </title>
...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Parametrização de Tipo de Movimentação do Grupo e Usuário </h2></div>
		<form action="UsuarioMovimentacaoTipo" method="post" name="Formulario" id="Formulario">
			...
			<div id="divEditar" class="divEditar">				
				<div id='ListaCheckBox'>
					...
					<%=request.getAttribute("ListaUlLiUsuarioMovimentacaoTipo").toString() %>
				</div>
