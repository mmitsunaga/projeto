		...
		<div id="divCorpo" class="divCorpo" >
			...
			<div id="divPortaBotoes" class="divPortaBotoes">
				...
				<input id="imgImprimir"  class="imgImprimir" title="Gerar Gráfico" name="imgImprimir" type="image" 
						src="./imagens/imgImprimir.png"   onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.Curinga7)%>')">	
			</div><br />
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao"> 
					...
					<input class="FormEdicaoimgLocalizar" id="imaLimparComarca" name="imaLimparSComarca" type="image"  src="./imagens/16x16/edit-clear.png"  onclick="LimparChaveEstrangeira('Id_Comarca','Comarca'); return false;" />
					</label><br>  
					
					
					<input id="Id_Comarca"  type="hidden" value="<%=GraficoProcessodt.getId_Comarca()%>"/>
					<input  class="formEdicaoInputSomenteLeitura" id="Comarca" name="Comarca" readonly type="text" size="60" maxlength="60" value="<%=GraficoProcessodt.getComarca()%>"/><br />
				</fieldset>
			  </div>
			</form>
		</div>
