...
<html>
	...
	<body>
  		<div id="divCorpo" class="divCorpo"> 
			<div class="area"><h2>&raquo; Processo de Execução - Cadastrar Cálculo</h2></div>
			...
			<form action="ProcessoExecucao" method="post" name="Formulario" id="Formulario">
				...
				<div id="divEditar" class="divEditar">
				    <fieldset class="formEdicao">					    	
				    	<legend class="formEdicaoLegenda">Execução Penal</legend>
...
<%if (ProcessoExecucaodt_PE.isProcessoNovo()){%>
						<fieldset class="formEdicao"><legend class="formEdicaoLegenda">Distribuição do Cálculo</legend><br>
