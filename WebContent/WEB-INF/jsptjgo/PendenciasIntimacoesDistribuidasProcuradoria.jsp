...
<head>
	...
	<%@ include file="js/PendenciasIntimacoesDistribuidasProcuradoria.js"%>
	
</head>
<body>
  <div class="divCorpo">
	<form action="Pendencia" method="post" name="Formulario" id="Formulario">
		<div class="area"><h2>&raquo; Intima&ccedil;&otilde;es/Citações Distribuídas</h2></div>
		...
		<div id="divLocalizar" class="divLocalizar">
			<fieldset id="formLocalizar" class="formLocalizar"  > 
				...
				<label class="formLocalizarLabel">Data da Intimação/Citação</label><br> 
								...
								%>
									<tr class="TabelaLinha<%=(qtd++%2 + 1)%>">
										...
										<td class="colunaMinima">
											<a href="PendenciaUsuarioServentiaResponsavel?PaginaAtual=<%=Configuracao.Novo%>&amp;pendencia=<%=obj.getId()%>&amp;CodigoPendencia=<%=obj.getHash()%>">
