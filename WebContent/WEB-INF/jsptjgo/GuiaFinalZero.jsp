...
<%@page import="br.gov.go.tj.projudi.ne.GuiaFinalZeroNe"%>
...
<head>
	...
	<title>TJGO/Projudi - Formulário de Guia de Custas Final Zero</title>
	<style type="text/css">
...
<body>
	<div id="divCorpo" class="divCorpo">
		...
		<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="GuiaFinalZero" id="GuiaFinalZero">
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset id="VisualizaDados">
                	...
                	<div class="col35"><label class="formEdicaoLabel"> Valor da Causa </label><br>
					...
					<div class="col35"><label class="formEdicaoLabel"> Data Recebimento do Processo </label><br>
					...
					<div class="col35"><label class="formEdicaoLabel">Valor Base para Cálculo</label><br>
					...
					<div class="col35"><label class="formEdicaoLabel"> Data Base para Cálculo </label><br>
					...
					<div class="col35"><label class="formEdicaoLabel">Valor da Causa Base Atualizado</label><br>
				...
				<fieldset id="VisualizaDados">
                	...
                	<div class="col35"><label class="formEdicaoLabel"> Tipo de Rateio </label><br>
						...
						if( listaPromoventes != null && listaPromoventes.size() > 0 ) {
							for( int i = 0; i < listaPromoventes.size(); i++ ) {
								...
								%>
									...
									%>
									<input type="text" id="<%=GuiaEmissaoNe.VARIAVEL_RATEIO_PARTE_VARIAVEL%><%=parteDt.getId()%>" name="<%=GuiaEmissaoNe.VARIAVEL_RATEIO_PARTE_VARIAVEL%><%=parteDt.getId()%>" value="<%=variavelRateioParteVariavel%>" maxlength="6" onkeyup="MascaraValor(this);autoTab(this,6);somarRateioPartesVariavel(this,<%=stringRateioParteJavascript%>);" onkeypress="return DigitarSoNumero(this, event)" />
				...
				<fieldset id="VisualizaDados">
                	...
                	<div class="col35"><label class="formEdicaoLabel"> Tipo de Cobrança </label><br>
                	...
                	<div class="col35"><label class="formEdicaoLabel"> Taxa de Serviço Dívida Ativa</label><br>
						...
						<select id="taxaServicoDividaAtivaQuantidade" name="taxaServicoDividaAtivaQuantidade">
							...
							<option <%=(GuiaEmissaoDt.getTaxaServicoDividaAtivaQuantidade().equals(GuiaEmissaoDt.VALOR_NAO)?"selected":"")%> value="<%=GuiaEmissaoDt.VALOR_NAO%>">NÃO</option>
						</select>
					</div>
					<%} %>
                </fieldset>
                ...
                <%if( !(Boolean)request.getAttribute("permiteAdicionarEscrivaoCrime") ) {%>
					<fieldset id="VisualizaDados">
	                	...
	                	<div class="col35"><label class="formEdicaoLabel">Percentual</label><br>
