								...
								<tr class="TabelaLinha<%=(qtd++%2 + 1)%>">
									...
									<td width="160">
										<%if (!obj.getId_Processo().equals("")){%>
											<a href="javascript:filtrar('<%=obj.getProcessoNumero()%>');"
												title="Clique para ver as pendencias abertas deste processo">
												<%=obj.getProcessoNumero()%>
											</a>
											
											<a href="BuscaProcesso?Id_Processo=<%=obj.getId_Processo()%>">
												<img src="imagens/imgLocalizarPequena.png" alt="Ver" title="Ver processo" />
											</a>
										<%}%>
									</td>
