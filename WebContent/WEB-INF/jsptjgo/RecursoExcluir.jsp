...
<jsp:useBean id="RecursoExcluirdt" scope="session" class= "br.gov.go.tj.projudi.dt.RecursoExcluirDt"/>
...
<html>
	<head>
		...
		<title> |<%=request.getAttribute("tempPrograma")%>| Excluir Recurso  </title>
	...
	<body>
		<div id="divCorpo" class="divCorpo" >
			<div class="area"><h2>&raquo; Excluir Recurso</h2></div>
			<form action="RecursoExcluir" method="post" name="Formulario" id="Formulario">
				...
				<div id="divEditar" class="divEditar">
					<fieldset class="formEdicao"> 
						<legend class="formEdicaoLegenda">Excluir Recurso </legend>
					    ...
					    <input type="hidden" name="Id_ProcessoTipo" id="Id_ProcessoTipo" value="<%=RecursoExcluirdt.getId_ProcessoTipo()%>">
					    <input type="hidden" name="ProcessoTipoCodigo" id="ProcessoTipoCodigo" value="<%=RecursoExcluirdt.getProcessoTipoCodigo()%>">
						<input class="formEdicaoInputSomenteLeitura"  readonly name="ProcessoTipo" id="ProcessoTipo" type="text" size="67" maxlength="100" value="<%=RecursoExcluirdt.getProcessoTipo()%>"/>
						<br />
