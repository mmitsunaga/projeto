...
<head>
	...
	<title>TJGO/Projudi - Formulário de Guia de Serviços</title>
	<style type="text/css">
...
<body>
	...
	<div id="divCorpo" class="divCorpo">	  	
		...
		<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="GuiaServicos" id="GuiaServicos">
			...
			<div id="divEditar" class="divEditar">
	            ...
	            <%} %>
               	...
               	<fieldset id="VisualizaDados" class="VisualizaDados">
					<legend style="background-color: #CCCCCC;">
                		Taxa Judiciária de Serviço - TJGO
                	</legend>
                	
                	<fieldset id="VisualizaDados" class="VisualizaDados">
	                	<legend>
	                		Item 06 - CERTIDÕES, traslados e Públicas Formas, extraídos de livros, processos ou de documentos existentes em cartórios
	                	</legend>
	                	
	                	<div> Quantidade </div>
						<span>
							<input type="text" name="taxaJudiciariaServicoCertidao" id="taxaJudiciariaServicoCertidao" value="<%=request.getParameter("taxaJudiciariaServicoCertidao")==null?"0":request.getParameter("taxaJudiciariaServicoCertidao")%>" maxlength="3" size="80" onkeypress="return DigitarSoNumero(this, event)" onblur="zerarCampoLimpo(this, '0')" />
						</span>
	                </fieldset>
