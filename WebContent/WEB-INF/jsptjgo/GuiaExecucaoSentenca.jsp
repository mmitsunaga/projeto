...
<%@page import="br.gov.go.tj.projudi.ne.GuiaExecucaoSentencaNe"%>
...
<head>
	...
	<title>TJGO/Projudi - Formulário de Guia de Custas Finais (Exec. de Sentença)</title>
	<style type="text/css">
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset id="VisualizaDados">
                	...
                	<div class="col45"><label class="formEdicaoLabel"> Tipo de Rateio </label><br>
						...
						<select id="rateioCodigo" name="rateioCodigo" onChange="mostrarDivRateioPartes('divRateioPartes',rateioCodigo.value,<%=stringRateioParteJavascript%>,<%=stringEmitirGuiaJavascript%>);">
							<option <%=(GuiaEmissaoDt.getRateioCodigo().equals(String.valueOf(GuiaExecucaoSentencaNe.RATEIO_100_REQUERENTE))?"selected":"") %> value="<%=GuiaExecucaoSentencaNe.RATEIO_100_REQUERENTE%>" >100% Requerente</option>
							<option <%=(GuiaEmissaoDt.getRateioCodigo().equals(String.valueOf(GuiaExecucaoSentencaNe.RATEIO_100_REQUERIDO))?"selected":"") %> value="<%=GuiaExecucaoSentencaNe.RATEIO_100_REQUERIDO%>">100% Requerido</option>
							<option <%=(GuiaEmissaoDt.getRateioCodigo().equals(String.valueOf(GuiaExecucaoSentencaNe.RATEIO_50_50))?"selected":"") %> value="<%=GuiaExecucaoSentencaNe.RATEIO_50_50%>">50% Para Cada Parte</option>
							<option <%=(GuiaEmissaoDt.getRateioCodigo().equals(String.valueOf(GuiaExecucaoSentencaNe.RATEIO_VARIAVEL))?"selected":"") %> value="<%=GuiaExecucaoSentencaNe.RATEIO_VARIAVEL%>">Rateio Variável</option>
						</select>
					</div>
                ...
                <fieldset id="VisualizaDados">
                	...
                	<div class="col35"><label class="formEdicaoLabel">Quantidade</label><br>
                		...
                		<input type="text" name="atosEscrivaesCivel" id="atosEscrivaesCivel" value="<%=GuiaEmissaoDt.getAtosEscrivaesCivel()%>" maxlength="3" size="5" onkeypress="return DigitarSoNumero(this, event)" onblur="zerarCampoLimpo(this, '0');minimoUm(this, 'Atos dos Escrivães do Cível');" />
                	</div>
				...
				<fieldset id="VisualizaDados">
					...
					<div class="col45"><label class="formEdicaoLabel"> Oficial de Justiça </label><br>
