	...
	<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
		...
		function VerificarCampos() {
			with(document.Formulario) {
				if (SeNulo(MandadoTipo, "O Campo MandadoTipo é obrigatório!")) return false;
				if (SeNulo(MandadoTipoCodigo, "O Campo MandadoTipoCodigo é obrigatório!")) return false;
				submit();
			}
		}
		</script>
...
<%}%>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					...
					<label class="formEdicaoLabel" for="MandadoTipo">*Descrição</label><br> <input class="formEdicaoInput" name="MandadoTipo" id="MandadoTipo"  type="text" size="60" maxlength="60" value="<%=MandadoTipodt.getMandadoTipo()%>" onkeyup=" autoTab(this,60)"/><br />
					<label class="formEdicaoLabel" for="MandadoTipoCodigo">*Código</label><br> <input class="formEdicaoInput" name="MandadoTipoCodigo" id="MandadoTipoCodigo"  type="text" size="10" maxlength="10" value="<%=MandadoTipodt.getMandadoTipoCodigo()%>" onkeypress="return DigitarSoNumero(this, event)" onkeyup=" autoTab(this,11)"/><br />
				</fieldset>
