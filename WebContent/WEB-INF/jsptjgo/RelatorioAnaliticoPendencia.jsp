	  	...
	  	<div id="divLocalizar" class="divLocalizar" > 
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao"> 
					...
					<br /><br />
				    <label for="Id_ServidorJudiciario">*Servidor
				    <input class="FormEdicaoimgLocalizar" name="imaLocalizarServidorJudiciario" type="image"  src="./imagens/imgLocalizarPequena.png"  onclick="AlterarValue('PaginaAtual','<%=String.valueOf(UsuarioDt.CodigoPermissao * Configuracao.QtdPermissao + Configuracao.Localizar)%>')" >
				    ...
				    <br /><br />
				    <label for="Id_PendenciaTipo">Tipo de Pendência
