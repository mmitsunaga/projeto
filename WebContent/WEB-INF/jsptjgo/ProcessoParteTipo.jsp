	...
	<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
		...
		function VerificarCampos() {
			with(document.Formulario) {
				if (SeNulo(ProcessoParteTipo, "O Campo ProcessoParteTipo é obrigatório!")) return false;
				if (SeNulo(ProcessoParteTipoCodigo, "O Campo ProcessoParteTipoCodigo é obrigatório!")) return false;
				submit();
			}
		}
		</script>
...
<%}%>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					...
					<label class="formEdicaoLabel" for="ProcessoParteTipo">*Descrição</label><br> <input class="formEdicaoInput" name="ProcessoParteTipo" id="ProcessoParteTipo"  type="text" size="60" maxlength="60" value="<%=ProcessoParteTipodt.getProcessoParteTipo()%>" onkeyup=" autoTab(this,60)"><br />
					<label class="formEdicaoLabel" for="ProcessoParteTipoCodigo">*Código</label><br> <input class="formEdicaoInput" name="ProcessoParteTipoCodigo" id="ProcessoParteTipoCodigo"  type="text" size="11" maxlength="11" value="<%=ProcessoParteTipodt.getProcessoParteTipoCodigo()%>" onkeypress="return DigitarSoNumero(this, event)" onkeyup=" autoTab(this,11)"><br />
				</fieldset>
