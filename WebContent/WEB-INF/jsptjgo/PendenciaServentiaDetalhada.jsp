...
<body>
  <div id="divCorpo" class="divCorpo" >
	...
	<form action="Pendencia" method="post" name="Formulario" id="Formulario">
		...
		<br />
		<button type="submit" name="operacao" value="MovimentarProcesso" onclick="AlterarValue('PaginaAtual', <%=Configuracao.Localizar%>);">
		...
		<div class="pendencia">
			<div class="dados">
				...
				<%if (!	(processoDt.getId_Processo().equals(""))){%>
					<fieldset class="fieldEdicaoEscuro">
						<legend>Processo a movimentar</legend>
					...
					if (lista != null && lista.size() > 0){%>
						<fieldset class="fieldEdicaoEscuro">
							...
							<table id="tabelaAndamentos" class="Tabela">
								...
								<tfoot>
									<tr>
										<td colspan="7">Quantidade de andamentos: <%=lista.size()%></td>
									</tr>
								</tfoot>
									...
									while (it.hasNext()){
										...
										<tr>
											...
											<td class="colunaMinima">
												...
												<a href="Pendencia?PaginaAtual=7&amp;pendencia=<%=obj.getId()%>&amp;CodigoPendencia=<%=obj.getHash()%>&amp;fluxo=10"
