...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Confirmar Operação no Processo</h2></div>
		<form action="<%=request.getAttribute("PaginaRetorno")%>" method="post" name="Formulario" id="Formulario">
		
			<input id="PaginaAtual" name="PaginaAtual" type="hidden" value="<%=request.getAttribute("PaginaAtual")%>" />
			<input  name="__Pedido__" type="hidden" value="<%=request.getAttribute("__Pedido__")%>" />
			<input id="fluxo" name="fluxo" type="hidden" value="<%=request.getAttribute("fluxo")%>" />
			<input id="PassoEditar" name="PassoEditar" type="hidden" value="<%=request.getAttribute("PassoEditar")%>">
			<input id="ProximaPaginaAtual" name="ProximaPaginaAtual" type="hidden" value="<%=request.getAttribute("ProximaPaginaAtual")%>">
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"> 
			    	...
			    	<fieldset id="VisualizaDados" class="VisualizaDados">
						...
						<div>Tr&acirc;nsito em Julgado</div>
