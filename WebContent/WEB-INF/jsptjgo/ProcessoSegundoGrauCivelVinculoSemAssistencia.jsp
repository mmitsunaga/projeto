...
<html>
	...
	<body>
  		<div id="divCorpo" class="divCorpo" >
			<div id="divTitulo" class="divTitulo"> Cadastro de Processo de 2º Grau Cível - Com Vínculo</div>
			...
			<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="Formulario" id="Formulario">
				...
				<div id="divEditar" class="divEditar">
					<fieldset class="formEdicao"> 
					    <legend class="formEdicaoLegenda">Passo 1 - Dados do Processo de 2º Grau - Sem Assistência</legend>
					    ...
					    <fieldset class="formEdicao">
				    	    ...
				    	    <label class="formEdicaoLabel" for="Id_Comarca">*Processo Originário</label>  
...
<!--				    	    <label class="formEdicaoLabel" for="Id_Serventia">*Área Distribuição</label>  -->
...
<!--				    		<input class="formEdicaoInputSomenteLeitura"  readonly name="Serventia" id="Serventia" type="text" size="60" maxlength="100" value="<%=ProcessoCadastroDt.getAreaDistribuicao()%>"/><br />-->
							...
							<%if((request.getAttribute("tempRetorno") != null &&  ( request.getAttribute("tempRetorno").toString().equalsIgnoreCase("ProcessoCivelSemAssistencia") || request.getAttribute("tempRetorno").toString().equalsIgnoreCase("ProcessoSegundoGrauCivelSemAssistenciaCt") ) )  && ProcessoCadastroDt.getNaturezaSPG() != null && ProcessoCadastroDt.getNaturezaSPG().trim().length() > 0) { %>
						    	<label class="formEdicaoLabel" for="Id_NaturezaSPG">*Natureza</label>
				    		...
				    		<label class="formEdicaoLabel" for="Valor">*Valor</label> 
