...
<html>
<head>
<title>Lista Mandados por Oficial</title>
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao">
					...
					<label class="formEdicaoLabel" for="tipoOpcao">*Tipo
						...
						<%-- option value="" ></option>  --%>
						<option value="1"> Mandados Concluídos no Período </option>
						<option value="2"> Mandados Com o Oficial na Data Atual</option>
						<option value="3"> Mandados Atrasados com o Oficial na Data Atual</option>
						<option value="4"> Mandados Direcionados Ad Hoc no Período</option>
						<option value="5"> Mandados Devolvidos no Período</option>
					</select><br />
