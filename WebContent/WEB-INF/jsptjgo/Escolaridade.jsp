	...
	<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
		...
		function VerificarCampos() {
			with(document.Formulario) {
				if (SeNulo(Escolaridade, "O campo Descrição é obrigatório!")) return false;
				submit();
			}
		}
		</script>
...
<%}%>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					...
					<label class="formEdicaoLabel" for="Escolaridade">*Descrição</label><br> <input class="formEdicaoInput" name="Escolaridade" id="Escolaridade"  type="text" size="60" maxlength="60" value="<%=Escolaridadedt.getEscolaridade()%>" onkeyup=" autoTab(this,60)"><br />
				</fieldset>
