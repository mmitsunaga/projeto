...
<html>
	...
	<body>
  		<div id="divCorpo" class="divCorpo"> 
			<div class="area"><h2>&raquo; Processo de Execução - Cadastrar Guia de Recolhimento </h2></div>
			...
			<form action="ProcessoExecucao" method="post" name="Formulario" id="Formulario">
				...
				<div id="divEditar" class="divEditar">
					...
					<fieldset class="formEdicao"><legend class="formEdicaoLegenda">Execução Penal</legend>
						...
						<fieldset class="formEdicao"><legend class="formEdicaoLegenda">Distribuição do Processo</legend><br>
							...
							<input class="formEdicaoInputSomenteLeitura"  readonly name="Comarca" id="Comarca" type="text" size="30" maxlength="100" value="<%=ProcessoExecucaodt_PE.getComarca()%>"/><br>
...
<!-- 				    		<label class="formEdicaoLabel" for="Id_Assunto">*Assunto CNJ</label><br>   -->
