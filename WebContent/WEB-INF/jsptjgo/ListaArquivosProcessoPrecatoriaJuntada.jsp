...
<body>
  <div  id="divCorpo" class="divCorpo">
 	...
 	<div class="area"><h2>&raquo; Encaminhando Documento</h2></div>
	 		...
	 		<div align="center"> 
			  <p class="style1">Selecione os Arquivos que Deverão ser Emcaminhado do Processo de Precatória ao Processo Principal</p>
			</div>
			...
			<br />
			<div align="center">
				<button type="submit" name="operacao" value="GerarPDF" onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.Localizar)%>'); AlterarValue('fluxo','4')" >
