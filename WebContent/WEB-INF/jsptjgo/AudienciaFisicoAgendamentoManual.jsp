...
<html>
	...
	<head>
		<!-- TITLE -->
		<title>Listar Audiências Livres Para Agendamento</title>
	...
	<body>
		...
		<div id="divCorpo" class="divCorpo">
			...
			<!-- FORM -->
			<form name="Formulario" id="Formulario" action="AudienciaFisico" method="post" >
				...
				<input type="hidden" id="AudienciaTipoCodigo" name="AudienciaTipoCodigo" value="<%=AudienciaFisicodt.getAudienciaTipoCodigo()%>" />
				...
				<div id="divLocalizar" class="divLocalizar">
					...
					<fieldset id="formLocalizar" class="formLocalizar">
				    	...
				    	<%=AudienciaFisicodt.getProcessoNumero()%>			    	
				    	</div>			
				    	<br />	    		
				    	<br />
						<div class="col25">
						<label for="DataInicialConsulta">Data Inicial</label><br> 
			    		<input class="formLocalizarInput" name="DataInicialConsulta" id="DataInicialConsulta" type="text" size="10" maxlength="10" value="<%=AudienciaFisicodt.getDataInicialConsulta()%>" /> 
			    		...
			    		<input class="formLocalizarInput" name="DataFinalConsulta" id="DataFinalConsulta" type="text" size="10" maxlength="10" value="<%=AudienciaFisicodt.getDataFinalConsulta()%>" /> 
						...
						<!-- Prazo para agendamento da audiência -->
			       		...
			       		<input class="formLocalizarInput" id="PrazoAgendamentoAudiencia" name="PrazoAgendamentoAudiencia" type="text" size="15" maxlength="20" onkeypress="return DigitarSoNumero(this, event)" value="<%=AudienciaFisicodt.getPrazoAgendamentoAudiencia()%>" />
			       		</div>
			       		<div class="clear"></div>
			    		<!-- DIV BOTÕES -->
				    	...
				    	<table id="Tabela" class="Tabela">
				        	...
				        	<thead>
				        		<tr class="TituloColuna1">
									<td colspan="3">Agendas Livres - Serventia: <%=AudienciaFisicodt.getServentia()%></td>
								</tr>
