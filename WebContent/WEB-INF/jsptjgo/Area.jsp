...
<head>
	...
	<title> |<%=request.getAttribute("tempPrograma")%>| Busca de Área  </title>
	...
	<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
		...
		function VerificarCampos() {
			with(document.Formulario) {
				...
				if (SeNulo(AreaCodigo, "O campo Código é obrigatório!")) return false;
				submit();
			}
		}
		</script>
...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Cadastro de Área</h2></div>
<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
...
<%}%>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					<legend class="formEdicaoLegenda">Edita os dados de Área </legend>
					...
					<label class="formEdicaoLabel" for="Area">*Área</label><br> <input class="formEdicaoInput" name="Area" id="Area"  type="text" size="20" maxlength="20" value="<%=Areadt.getArea()%>" onkeyup=" autoTab(this,60)"><br />
					<label class="formEdicaoLabel" for="AreaCodigo">*Código</label><br> <input class="formEdicaoInput" name="AreaCodigo" id="AreaCodigo"  type="text" size="6" maxlength="6" value="<%=Areadt.getAreaCodigo()%>" onkeypress="return DigitarSoNumero(this, event)" onkeyup=" autoTab(this,6)"><br />
				</fieldset>
