...
<html>
<head>
<title>Valida Ordem Pagamento de Mandados Gratuitos</title>
	...
	<div id="divCorpo" class="divCorpo">
		<form action="<%=request.getAttribute("tempRetorno")%>" method="post"
			...
			<div id="divEditar" class="divEditar">
				<h2>&raquo; Autoriza Pagamento de Mandados Gratuitos</h2>	
			...
			<input type="image"  src="./imagens/imgAtualizar.png"   title="Lista Mandados Concluídos na Data Informada" class="imgEditar" 
						onclick="AlterarValue('PaginaAtual','6'); 
					             AlterarValue('Fluxo','buscaOrdemPgGratuito')"				             
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao">
				  ...
				  <label class="formEdicaoLabel" for="dataReferencia">*Esta pesquisa lista os mandados dentro do mês escolhido.
						</label><br> 
				...
				<tbody id="listaMandado">
					...
					<tr class="TabelaLinha<%=(boLinha ? 1 : 2)%>">
						...
						<td><input id="imgEditar" class="imgEditar"
							...
							onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.Curinga6)%>') ; AlterarValue('Fluxo','editaOrdemPgGratuito');							
