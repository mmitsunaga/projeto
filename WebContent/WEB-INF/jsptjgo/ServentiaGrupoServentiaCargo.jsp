...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Cadastro de  ServentiaGrupoServentiaCargo</h2></div>
		<form action=" ServentiaGrupoServentiaCargo" method="post" name="Formulario" id="Formulario">
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					<legend class="formEdicaoLegenda">Edita os dados  ServentiaGrupoServentiaCargo </legend>
					<label class="formEdicaoLabel" for="Id_ServentiaGrupo">ServGrupo
					...
					</label><br>   					<input  class="formEdicaoInputSomenteLeitura"  readonly="true" name="ServGrupo" id="SERV_GRUPO" type="text" value="<%= ServentiaGrupoServentiaCargodt.getServentiaGrupo()%>"><br />
				</fieldset>
				<br />
				<div id='ListaCheckBox'>
					...
					<%=request.getAttribute("ListaUlLi ServentiaGrupoServentiaCargo").toString() %>
				</div>
