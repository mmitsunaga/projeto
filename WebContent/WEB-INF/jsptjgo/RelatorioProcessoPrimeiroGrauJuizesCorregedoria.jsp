		...
		<div id="divCorpo" class="divCorpo">
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao" id="fieldsetServentia" > 
					...
					<input id="Id_Serventia" name="Id_Serventia" type="hidden" value="<%=relatorioProcessoPrimeiroGrauDt.getIdServentiaConsulta()%>"/>
					<input class="formEdicaoInputSomenteLeitura" id="Serventia" name="Serventia" readonly="true" type="text" size="60" maxlength="60" value="<%=relatorioProcessoPrimeiroGrauDt.getServentiaConsulta()%>"/><br />
				</fieldset> 
