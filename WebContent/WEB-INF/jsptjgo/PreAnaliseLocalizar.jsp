...
<head>
	...
	<script type="text/javascript" src="./js/acessibilidadeMenu.js"></script>  
	 <script type="text/javascript">
	    	...
	    	function submeter2(action, id_Pendencia, paginaAtual, visualizar){
	    		AlterarAction('Formulario', action);
	    		AlterarValue('PaginaAtual', paginaAtual);
	    		AlterarValue('Id_Pendencia', id_Pendencia);
	    		AlterarValue('Visualizar', visualizar);
	    		document.Formulario.submit();
	    	}
	    </script>
	    <script type="text/javascript">
	...
	<div id="divCorpo" class="divCorpo" >
		...
		<div id="divLocalizar" class="divLocalizar"> 
			<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="Formulario" id="Formulario">
				...
				<input id="Visualizar" name="Visualizar" type="hidden" />
						...
						<table id="Tabela" class="Tabela">
							<thead>
								<tr class="TituloColuna">
									...
									<th width="45%">Usuário Pré-Análise</th>									
							...
							if (liTemp !=null){
								...
								<tr class="<%=estiloLinha%>">
									...
									%>
		                   			...
		                   			<td align="center">
		                   				<a href="#" onclick="javascript: submeter2('PreAnalisarConclusao', '<%=pendenciaDt.getId()%>','<%=Configuracao.Novo%>','true');return false;">
					                   		<img src='./imagens/32x32/btn_localizar.png' alt="Visualizar" title="Visualizar"/>
					                   	</a>	
				                   	</td>
