...
<head>
	...
	<%@ include file="js/PendenciaExpedidasServentia.js"%>
...
<body>
  <div class="divCorpo">
	...
	<form action="Pendencia" method="post" name="Formulario" id="Formulario">
		<div class="area"><h2>&raquo; Acompanhamento de Pend&ecirc;ncias da Serventia</h2></div>
		<input id="PaginaAtual" name="PaginaAtual" type="hidden" value="<%=request.getAttribute("PaginaAtual")%>" />
		<input id="PaginaAnterior" name="PaginaAnterior" type="hidden" value="<%=request.getAttribute("PaginaAnterior")%>" />
		
		<input name="fluxo" type="hidden" value="1" />
			...
			<fieldset id="formLocalizar" class="formLocalizar"> 
				...
				<div id="divConfirmarSalvar" class="ConfirmarSalvar">	       	
					<button id="formLocalizarBotao" class="formLocalizarBotao" type="submit" name="Localizar" value="Consultar"
						...
						title="Consultar as pend&ecirc;ncias">
			   	...
			   	<table id="Tabela" class="Tabela">
			       	<thead>
			           	<tr>
			                ...
			                <th>Processo</th>
			                <th width="200">Movimenta&ccedil;&atilde;o</th>
			                <th width="150">Tipo</th>
			                <th width="100">Status</th>
			                <th width="85" align="center">In&iacute;cio</th>
							...
							%>
								<tr class="TabelaLinha<%=(qtd++%2 + 1)%>">
									...
									<td class="colunaMinima">
										<a href="Pendencia?PaginaAtual=6&amp;pendencia=<%=obj.getId()%>&amp;CodigoPendencia=<%=obj.getHash()%>&amp;fluxo=4" 
