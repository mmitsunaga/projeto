...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Alterar Partes do Recurso</h2></div>
		<form action="RecursoParte" method="post" name="Formulario" id="Formulario">
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"> 
					<legend class="formEdicaoLegenda">Alterar Partes do Recurso </legend>
				    ...
				    <input type="hidden" name="Id_ProcessoTipo" id="Id_ProcessoTipo" value="<%=Recursodt.getId_ProcessoTipoRecursoParteAtual()%>">
				    <input class="formEdicaoInputSomenteLeitura"  readonly name="ProcessoTipo" id="ProcessoTipo" type="text" size="67" maxlength="100" value="<%=Recursodt.getProcessoTipoRecursoParteAtual()%>"/><br />
						...
						<%
	 					...
	 					%>
			   				<div>
				   				...
				   				<%	
				   					List listaRecorridos = (List) request.getSession().getAttribute("ListaRecorridos");
