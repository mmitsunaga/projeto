...
<body>
  <div id="divCorpo" class="divCorpo" >
	...
	<form action="Pendencia" method="post" name="Formulario" id="Formulario">
		...
		<%if (Pendenciadt.isPendenciaDeProcesso() && Pendenciadt.getDataFim() != null && !Pendenciadt.getDataFim().equals("")){ %>
		...
		<button type="submit" title="Vistar pendência" name="operacao" value="VistarPendencia" onclick="AlterarValue('PaginaAtual', <%=Configuracao.Curinga7%>); AlterarValue('fluxo','6');">
		...
		&nbsp;&nbsp;&nbsp;
		<a href="Pendencia?PaginaAtual=<%=Configuracao.Curinga7%>&amp;fluxo=4">
				Acompanhamento
		</a>
		
		&nbsp;&nbsp;&nbsp;
		<a href="Pendencia?PaginaAtual=<%=Configuracao.Curinga7%>&amp;fluxo=5">
				Finalizadas
		</a>
		<br /><br />
