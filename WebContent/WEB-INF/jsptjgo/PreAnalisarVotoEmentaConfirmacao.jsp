...
<html>
<head>
	<title>Movimentar Processoff</title>	
	...
	<div id="divCorpo" class="divCorpo">
		...
		<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="Formulario" id="Formulario">
			...
			<input id="ementa" name="ementa" type="hidden" value="">
				...
				<fieldset class="formEdicao">
					...
					<div id="divBotoesCentralizados" class="divBotoesCentralizados">
						...
						<%if (UsuarioSessao.isPodeTrocarResponsavelDistribuicao()){ %>
							<input name="imgDistribuirConclusao" type="submit" value="Salvar e Distribuirr" onclick="AlterarValue('PaginaAtual','<%=Configuracao.SalvarResultado%>'); AlterarValue('SalvarRedistribuir','true'); AlterarValue('pendencia','<%=AnalisePendenciadt.getPrimeiraPendenciaListaFechar().getId()%>');AlterarValue('CodigoPendencia','<%=AnalisePendenciadt.getPrimeiraPendenciaListaFechar().getHash()%>'); AlterarValue('ementa','<%=AnalisePendenciadt.getId_Pendencia_Ementa()%>');" />
						<%}%>
					</div>
				</fieldset>
			</div>
