...
<%@page import="br.gov.go.tj.projudi.ne.GuiaRecursoInominadoQueixaCrimeNe"%>
...
<head>
	...
	<title>TJGO/Projudi - Formulário de Guia de Recurso Inominado Queixa-Crime</title>
	<style type="text/css">
		...
		<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="GuiaInicial" id="GuiaInicial">
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset id="VisualizaDados">
                	...
                	<div class="col45">
                	<label class="formEdicaoLabel">Valor da Causa</label><br>
					...
					<div class="col45">
                	<label class="formEdicaoLabel"> Data Recebimento do Processo </label><br>
					...
					<div class="col45">
                	<label class="formEdicaoLabel">Valor Base para Cálculo</label><br>
					...
					<div class="col45">
                	<label class="formEdicaoLabel"> Data Base para Cálculo </label><br>
					...
					<div class="col45">
                	<label class="formEdicaoLabel">Valor da Causa Base Atualizado</label><br>
				...
				<fieldset id="VisualizaDados">
                	...
                	<div class="col45">
                	<label class="formEdicaoLabel"> Tipo de Rateio </label><br>
						...
						<select id="rateioCodigo" name="rateioCodigo" onChange="mostrarDivRateioPartes('divRateioPartes',rateioCodigo.value,<%=stringRateioParteJavascript%>,<%=stringEmitirGuiaJavascript%>);">
							<option <%=(GuiaEmissaoDt.getRateioCodigo().equals(String.valueOf(GuiaRecursoInominadoQueixaCrimeNe.RATEIO_100_REQUERENTE))?"selected":"") %> value="<%=GuiaRecursoInominadoQueixaCrimeNe.RATEIO_100_REQUERENTE%>" >100% Requerente</option>
							<option <%=(GuiaEmissaoDt.getRateioCodigo().equals(String.valueOf(GuiaRecursoInominadoQueixaCrimeNe.RATEIO_100_REQUERIDO))?"selected":"") %> value="<%=GuiaRecursoInominadoQueixaCrimeNe.RATEIO_100_REQUERIDO%>">100% Requerido</option>
							<option <%=(GuiaEmissaoDt.getRateioCodigo().equals(String.valueOf(GuiaRecursoInominadoQueixaCrimeNe.RATEIO_50_50))?"selected":"") %> value="<%=GuiaRecursoInominadoQueixaCrimeNe.RATEIO_50_50%>">50% Para Cada Parte</option>
						</select>
					</div>
				...
				<fieldset id="VisualizaDados">
                	...
                	<div class="col45">
                	<label class="formEdicaoLabel"> Recorrente </label><br>
					...
					<div class="col45">
                	<label class="formEdicaoLabel"> Recorrido </label><br>
				...
				<fieldset id="VisualizaDados">
                	...
                	<div class="col45">
                	<label class="formEdicaoLabel"> Tipo de Cobrança</label><br>
	                	...
	                	if( liTemp != null && liTemp.size() > 0 ) {
							...
							<tr>
							  ...
							  <td align="center"><%= bairroAuxDt.getUf() %></td>
  		       				  <td align="center"><input name="imgExcluir" class="imgExcluir" type="image" src="./imagens/imgExcluirPequena.png" onclick="AlterarValue('PaginaAtual','<%=Configuracao.Excluir%>');AlterarValue('posicaoListaBairroExcluir','<%=i%>');AlterarValue('PassoEditar','<%=Configuracao.Curinga7%>');" title="Excluir esta Locomoção" /></td>
							<%
							}
							%>
							</tbody>
