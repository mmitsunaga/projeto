			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao" id="fieldsetData"> 
					...
					<select id="MesInicial" name ="MesInicial" class="formEdicaoCombo">
						...
						<option value="3" <%if(relatorioConclusoesPrimeiroGrauDt.getMesInicial().equals("3")){%>selected="true"<%}%>>Março</option>
					...
					<select id="MesFinal" name ="MesFinal" class="formEdicaoCombo">
						...
						<option value="3" <%if(relatorioConclusoesPrimeiroGrauDt.getMesFinal().equals("3")){%>selected="true"<%}%>>Março</option>
