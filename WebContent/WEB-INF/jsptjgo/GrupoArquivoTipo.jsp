...
<%@page  import="br.gov.go.tj.projudi.dt.GrupoArquivoTipoDt"%>
<%@page  import="br.gov.go.tj.utils.Configuracao"%>


<jsp:useBean id="GrupoArquivoTipodt" scope="session" class= "br.gov.go.tj.projudi.dt.GrupoArquivoTipoDt"/>
...
<%-----%>
<%--<jsp:setProperty name="objArquivoTipo" property="*"/>--%>

<html>
<head>
	<meta content="text/html; charset=LATIN1" http-equiv="CONTENT-TYPE"/>
	<title> |<%=request.getAttribute("tempPrograma")%>| Busca de Tipo de Arquivo do Grupo  </title>
...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Cadastro de Tipo de Arquivo do Grupo</h2></div>
		<form action="GrupoArquivoTipo" method="post" name="Formulario" id="Formulario">
			...
			<div id="divPortaBotoes" class="divPortaBotoes">
				...
				<a class="divPortaBotoesLink" href="Ajuda/GrupoArquivoTipoAjuda.html" target="_blank">  <img id="imgAjuda" class="imgAjuda" title="Ajuda" src="./imagens/imgAjuda.png"/> </a>
			</div>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					<legend class="formEdicaoLegenda">Edita os dados de Tipo de Arquivo de Grupo </legend>
					...
					</label><br>  				<input  class="formEdicaoInputSomenteLeitura"  readonly="true" name="Grupo" id="Grupo" type="text" size="60" value="<%=GrupoArquivoTipodt.getGrupo()%>"/><br />
				</fieldset/><br />
				<div id='ListaCheckBox'>
					...
					<%=request.getAttribute("ListaUlLiGrupoArquivoTipo").toString() %>
				</div>
