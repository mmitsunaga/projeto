		...
		<div id="divLocalizar" class="divLocalizar"> 
			<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="Formulario" id="Formulario">
				...
				<div id="divTabela" class="divTabela" > 
					...
					<br />
					<div id="divBotoesCentralizados" class="divBotoesCentralizados">
						<input name="imgAssinar" type="submit" value="Assinar Selecionadas" onclick="senhaDigitadaAssinarPendencia(); return false;" />							
						<input name="imgDescartar" type="submit" value="Voltar para pré-análise" onclick="AlterarAction('Formulario','AssinarPendencia');AlterarValue('PaginaAtual','<%=Configuracao.Salvar%>');AlterarValue('acaoSalvar','<%=Configuracao.Curinga7%>');" />						
					</div>
					...
					<%if(String.valueOf(request.getAttribute("OperacaoExpedirImprimir")).equalsIgnoreCase("ExpedirImprimir")){%>
