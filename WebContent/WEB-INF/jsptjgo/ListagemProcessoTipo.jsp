	  	...
	  	<div id="divLocalizar" class="divLocalizar" > 
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao"> 
					...
					<input class="formEdicaoInput" name="ProcessoTipo" id="ProcessoTipo"  type="text" size="60" maxlength="60" value="<%=ProcessoTipodt.getProcessoTipo()%>" onkeyup=" autoTab(this,60)"/>
					<br />
			...
			<div id="divTabela" class="divTabela" > 
			   		<table id="Tabela" class="Tabela">
						...
						<%
						if(request.getAttribute("listaProcessoTipo")!=null){
			  			...
			  			for(int i = 0 ; i < liTemp.size();i++) {
							...
							<%}%>
								<td class="Centralizado" ><%= i+1 %></td>
			                   	<td class="Centralizado" ><%= objTemp.getProcessoTipo()%></td>
			               	</tr>
						<%}%>
			           </tbody>
			      	</table>     
