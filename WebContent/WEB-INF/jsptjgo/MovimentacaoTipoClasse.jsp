...
<head>
	...
	<title> |<%=request.getAttribute("tempPrograma")%>| Busca de Movimentação Tipo Classe  </title>
	...
	<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
		...
		function VerificarCampos() {
			with(document.Formulario) {
				if (SeNulo(MovimentacaoTipoClasse, "O Campo Descrição é obrigatório!")) return false;
				if (SeNulo(MovimentacaoTipoClasseCodigo, "O Campo Código é obrigatório!")) return false;
				submit();
			}
		}
		</script>
...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Cadastro de Movimentação Tipo Classe</h2></div>
<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
...
<%}%>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					<legend class="formEdicaoLegenda">Edita os dados Movimentação Tipo Classe </legend>
					...
					<label class="formEdicaoLabel" for="MovimentacaoTipoClasse">*Descrição</label><br> 
					...
					<label class="formEdicaoLabel" for="MovimentacaoTipoClasseCodigo">*Código</label><br> 
