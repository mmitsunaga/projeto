...
<%@page  import="br.gov.go.tj.projudi.dt.ServentiaSubtipoAssuntoDt"%>
<%@page  import="br.gov.go.tj.utils.Configuracao"%>
<jsp:useBean id="ServentiaSubtipoAssuntodt" scope="session" class= "br.gov.go.tj.projudi.dt.ServentiaSubtipoAssuntoDt"/>
...
<head>
	...
	<title> |<%=request.getAttribute("tempPrograma")%>| Busca de Assunto de Subtipo de Serventia  </title>
	...
	<script type="text/javascript">
		function alterarServentiaSubtipoAssunto(id, id_assunto, id_serventia_subtipo) {
			if($('#chkEditar'+id_assunto).prop('checked')){
				salvarItemSelecaoMultipla('ServentiaSubtipoAssunto',id_serventia_subtipo,id_assunto,6);
			}else{
				if (id!=undefined && id!=""){
					excluirItemSelecaoMultipla('ServentiaSubtipoAssunto',id,6);
				}
			}
		}
	</script>
...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Cadastro de Assunto de Subtipo de Serventia</h2></div>
		<form action="ServentiaSubtipoAssunto" method="post" name="Formulario" id="Formulario">
			...
			<div id="divPortaBotoes" class="divPortaBotoes">
				...
				<a class="divPortaBotoesLink" href="Ajuda/ServentiaSubtipoAssuntoAjuda.html" target="_blank">  <img id="imgAjuda" class="imgAjuda" title="Ajuda" src="./imagens/imgAjuda.png" /> </a>
			</div>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					<legend class="formEdicaoLegenda">Edita os dados de Assunto de Subtipo de Serventia </legend>
					...
					<input  class="formEdicaoInputSomenteLeitura"  readonly="true" name="ServentiaSubtipo" id="ServentiaSubtipo" type="text" value="<%=ServentiaSubtipoAssuntodt.getServentiaSubtipo()%>" size="100"><br />
				</fieldset>
			</div>
		</form>
		...
		<div id='ListaCheckBox'>
			...
			<%=request.getAttribute("ListaUlLiServentiaSubtipoAssunto").toString() %>
		</div>
