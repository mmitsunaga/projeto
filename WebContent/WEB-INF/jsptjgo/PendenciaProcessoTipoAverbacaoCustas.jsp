...
<div  id="divCorpo" class="divCorpo">
	...
	<form action="Pendencia" method="post" id="Formulario">
			<div class="area"><h2>&raquo; Resolver Pend&ecirc;ncia Processo Averbação de Custas</h2></div>
			...
			<div id="divEditar" class="divEditar">			
				...
				<div id="dados">
					...
					<div id="divBotoesCentralizados" class="divBotoesCentralizados">
						...
						<button type="submit" name="operacao" value="ConfirmarAverbacaoCustas" onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.Salvar)%>')">
						...
						<%if (request.getAttribute("habilitarResponder") != null && request.getAttribute("habilitarResponder").toString().equalsIgnoreCase("true")){ %> 
							<button type="submit" name="operacao" value="FinalizarAverbacaoCustas" onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.SalvarResultado)%>')">
							<!-- <img src="imagens/22x22/ico_sucesso.png" alt="Finalizar e Marcar Audiência" /> -->
									Finalizar e Averbar Custas
							</button>
						<% } else {%>
							<button type="submit" disabled="false" name="operacao" value="FinalizarAverbacaoCustas" onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.SalvarResultado)%>')">
								<!-- <img src="imagens/22x22/ico_sucesso.png" alt="Finalizar e Marcar Audiência" /> -->
									Finalizar  e Averbar Custas
							</button>
						<%} %>
