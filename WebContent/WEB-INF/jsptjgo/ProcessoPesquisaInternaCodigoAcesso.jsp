...
<html>
	...
	<body>
  		<div id="divCorpo" class="divCorpo" >
	  		...
	  		<form action="BuscaProcessoInternaCodigoAcesso" method="post" name="Formulario" id="Formulario">
				...
				<div id="divEditar" class="divEditar">
					<fieldset class="formEdicao"> 
					    ...
					    <em>Digite o Número do Processo "ponto" (ou "traço") e o Dígito Ex. <b>048032.01</b> ou <b>048032-01</b></em>
					    <br />
					    ...
					    <em> Código diferencia letras maiúsculas e minúsculas</em>
					    <br />
					    ...
					    <br />  
				   		<div id="divBotoesCentralizados" class="divBotoesCentralizados">
							...
							<button id="formLocalizarBotao" class="formLocalizarBotao" type="submit" name="Limpar" value="Limpar" onclick="AlterarValue('PaginaAtual','<%=Configuracao.Novo%>');">
								<img src='imagens/22x22/edit-clear.png' alt="Consultar Processo" />Limpar
							</button>	
						</div>
					</fieldset>		
				</div>
