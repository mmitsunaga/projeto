	...
	<div id="divCorpo" class="divCorpo">
		<form action="" RelatoriosMandado" method="post" name="Formulario"
			...
			<div id="divEditar" class="divEditar">
				<h2>&raquo; Mandados Distribuídos no Período</h2>
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao">
					...
					<fieldset class="formEdicao">
						...
						<label class="formEdicaoLabel" for="tipoMandado">*Assistência</label><br>
						<input type="radio" name="assistencia" value="sim" checked="true" />Sem
						Custas<input type="radio" name="assistencia" value="nao" />Com
						Custas<br> <br> <label class="formEdicaoLabel"
							for="tipoRelatorio">*TipoRelatorio</label><br> <input
							type="radio" name="tipoRelatorio" value="analitico"
							checked="true" />Analítico <input type="radio"
							name="tipoRelatorio" value="sintetico" />Sintetico <br> <br>
