...
<html>
	<head>
		<title>Processo de Segundo Grau Criminal</title>
	...
	<body>
  		<div id="divCorpo" class="divCorpo" >
			<div class="area"><h2>&raquo; Cadastro de Processo de Segundo Grau Criminal</h2></div>
			...
			<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="Formulario" id="Formulario">
				...
				<div id="divEditar" class="divEditar">
					<fieldset class="formEdicao"> 
					    ...
					    <fieldset>
				    	    ...
				    	    <div class="col50">
						    <label class="formEdicaoLabel" for="Id_Serventia">*Área Distribuição
				    		...
				    		<input class="formEdicaoInputSomenteLeitura"  readonly name="Serventia" id="Serventia" type="text" size="60" maxlength="100" value="<%=ProcessoCadastroDt.getAreaDistribuicao()%>"/>
						    ...
						    <input class="formEdicaoInputSomenteLeitura"  readonly name="ProcessoTipo" id="ProcessoTipo" type="text" size="90" maxlength="100" value="<%=ProcessoCadastroDt.getProcessoTipo()%>"/>
				...
				<div class="clear"></div>
					    ...
					    <div id="divBotoesCentralizados" class="divBotoesCentralizados">
							<input name="imgInserir" type="submit" value="Inserir" onclick="AlterarValue('PaginaAtual','<%=Configuracao.Editar%>');AlterarValue('PassoEditar','5');"> 
