...
<%@page  import="br.gov.go.tj.projudi.dt.GrupoPendenciaTipoDt"%>
<%@page  import="br.gov.go.tj.utils.Configuracao"%>


<jsp:useBean id="GrupoPendenciaTipodt" scope="session" class= "br.gov.go.tj.projudi.dt.GrupoPendenciaTipoDt"/>
...
<%-----%>
<%--<jsp:setProperty name="objPendenciaTipo" property="*"/>--%>

<html>
<head>
	<meta content="text/html; charset=LATIN1" http-equiv="CONTENT-TYPE"/>
	<title> |<%=request.getAttribute("tempPrograma")%>| Busca de Tipo de Pendência do Grupo  </title>
...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2>&raquo; Cadastro de Tipo de Pendência do Grupo</h2></div>
		<form action="GrupoPendenciaTipo" method="post" name="Formulario" id="Formulario">
			...
			<div id="divPortaBotoes" class="divPortaBotoes">
				...
				<a class="divPortaBotoesLink" href="Ajuda/GrupoPendenciaTipoAjuda.html" target="_blank">  <img id="imgAjuda" class="imgAjuda" title="Ajuda" src="./imagens/imgAjuda.png"/> </a>
			</div>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					<legend class="formEdicaoLegenda">Edita os dados de Tipo de Pendência do Grupo </legend>
					...
					</label><br>  					<input  class="formEdicaoInputSomenteLeitura"  readonly="true" name="Grupo" id="Grupo" type="text" size="60" value="<%=GrupoPendenciaTipodt.getGrupo()%>"/><br />
				</fieldset/><br />
				<div id='ListaCheckBox'>
					...
					<%=request.getAttribute("ListaUlLiGrupoPendenciaTipo").toString() %>
				</div>
