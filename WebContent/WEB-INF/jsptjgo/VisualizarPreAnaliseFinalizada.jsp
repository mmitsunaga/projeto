		...
		<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="Formulario" id="Formulario">
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao">
					...
					<label class="formEdicaoLabel"> Tipo Conclusão </label><br>
							...
							<thead>
	  						...
	  						<tbody>
	  							...
	  							<% PendenciaArquivoDt arquivoPreAnalise = AnalisePendenciadt.getArquivoPreAnalise(); %>
  									...
  									<td>
			      						<a href="<%=request.getAttribute("linkArquivo")%>?PaginaAtual=<%=request.getAttribute("paginaArquivo")%>&amp;<%=request.getAttribute("campoArquivo")%>=<%=arquivoPreAnalise.getId()%>&amp;hash=<%=arquivoPreAnalise.getHash()%>&amp;finalizado=true">
					...
					<fieldset class="formLocalizar">
					<legend>Histórico Conclusão</legend>
					<table class="Tabela">
						<thead>
    						<tr>
					      		<th width="15%">Data</th>
