...
<head>
	...
	<title> |<%=request.getAttribute("tempPrograma")%>| Busca de Vínculo  </title>
	...
	<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
		...
		function VerificarCampos() {
			with(document.Formulario) {
				if (SeNulo(Vinculo, "O Campo Vínculo é obrigatório!")) return false;
				submit();
			}
		}
		</script>
...
<body>
	<div id="divCorpo" class="divCorpo" >
		<div class="area"><h2> Cadastro de Víinculo</h2></div>
			<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao"  > 
					<legend class="formEdicaoLegenda">Edita os dados Vínculo </legend>
					...
					<label class="formEdicaoLabel" for="Vinculo">*Vínculo</label> <input class="formEdicaoInput" name="Vinculo" id="Vinculo"  type="text" size="60" maxlength="60" value="<%=Vinculodt.getVinculo()%>" onkeyup=" autoTab(this,60)"><br />
				</fieldset>
