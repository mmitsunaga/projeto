	...
	<% if (request.getAttribute("PaginaAnterior").toString().equalsIgnoreCase(String.valueOf(Configuracao.Salvar)))  {%>
		...
		function VerificarCampos() {
			with(document.Formulario) {
				...
				if (SeNulo(ProcessoTipoCodigo, "O Campo ProcessoTipoCodigo é obrigatório!")) return false;
				submit();
			}
		}
		</script>
...
<%}%>
			...
			<div id="divEditar" class="divEditar">
				<fieldset class="formEdicao"  > 
					...
					<label class="formEdicaoLabel" for="ProcessoTipo">*Descrição</label><br> <input class="formEdicaoInput" name="ProcessoTipo" id="ProcessoTipo"  type="text" size="60" maxlength="60" value="<%=ProcessoTipodt.getProcessoTipo()%>" onKeyUp=" autoTab(this,60)"><br />
					<label class="formEdicaoLabel" for="ProcessoTipoCodigo">*Código</label><br> <input class="formEdicaoInput" name="ProcessoTipoCodigo" id="ProcessoTipoCodigo"  type="text" size="11" maxlength="11" value="<%=ProcessoTipodt.getProcessoTipoCodigo()%>" onKeyPress="return DigitarSoNumero(this, event)" onKeyUp=" autoTab(this,11)"><br />
   					<label class="formEdicaoLabel" for="CnjCodigo">*CNJ Código</label><br> <input class="formEdicaoInput" name="CnjCodigo" id="CnjCodigo"  type="text" size="11" maxlength="11" value="<%=ProcessoTipodt.getCnjCodigo()%>" onKeyPress="return DigitarSoNumero(this, event)" onKeyUp=" autoTab(this,11)"><br />
					<label class="formEdicaoLabel" for="Ordem2Grau">Ordem 2º Grau</label><br> <input class="formEdicaoInput" name="Ordem2Grau" id="Ordem2Grau"  type="text" size="11" maxlength="4" value="<%=ProcessoTipodt.getOrdem2Grau()%>" onKeyPress="return DigitarSoNumero(this, event)" onKeyUp=" autoTab(this,4)"><br />
