...
<div class="divCorpo">
	<form action="Pendencia" method="post" id="Formulario">
		...
		<div id="divLocalizar" class="divLocalizar" >
			<div class="area"><h2>&raquo; Pend&ecirc;ncias Reservadas</h2></div>
			<fieldset id="formLocalizar" class="formLocalizar"> 
				...
				<button type="submit" name="operacao" value="LiberarSelecionadas"
					title="Liberar todas as pend&ecirc;ncias selecionadas" onclick="AlterarValue('fluxo', 1);">
				...
				<table id="Tabela" class="Tabela">
					<thead>
						<tr>
							...
							<th>Status</th>
							<th>Data Inicio</th>
							<th width="10%" >Reservado At&eacute;</th>
