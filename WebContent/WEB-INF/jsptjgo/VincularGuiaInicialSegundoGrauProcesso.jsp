				...
				<div id="divEditar" class="divEditar">
					...
					<fieldset id="formLocalizar" class="formLocalizar"> 
						...
						<label id="formLocalizarLabel" class="formLocalizarLabel">
							Informe o número da Guia Inicial de Segundo Grau(Somente Números) Ex. <strong>22152109</strong>
							<br/>
						...
						<span>
							<input id="numeroCompletoGuiaInicialSegundoGrau" class="formLocalizarInput" name="numeroCompletoGuiaInicialSegundoGrau" type="text" value="<%=request.getAttribute("numeroCompletoGuiaInicialSegundoGrau")%>" size="20" maxlength="11" onkeypress="return DigitarSoNumero(this, event)" title="Informe somente o número da Guia Inicial de Segundo Grau" />
						</span>
