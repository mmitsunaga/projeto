<script type="text/javascript">
	function buscaDados(posicao, tamanho) {
		...
		url = 'PendenciaJson?AJAX=ajax&PaginaAtual=3&fluxo=5&Id_PendenciaTipo='+document.getElementById('Id_PendenciaTipo').value+'&numeroProcesso='+document.getElementById('numeroProcesso').value+'&PosicaoPaginaAtual=' + posicao;
