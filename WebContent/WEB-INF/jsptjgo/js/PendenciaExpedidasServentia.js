<script type="text/javascript">
	function buscaDados(posicao, tamanho) {
		...
		url = 'PendenciaJson?AJAX=ajax&PaginaAtual=3&fluxo=4&dataInicialInicio='+document.getElementById('dataInicialInicio').value+'&dataFinalInicio='+document.getElementById('dataFinalInicio').value+'&Id_PendenciaTipo='+document.getElementById('Id_PendenciaTipo').value+'&Id_PendenciaStatus='+document.getElementById('Id_PendenciaStatus').value+'&prioridade='+true+'&filtroTipo='+Formulario.filtroTipo.value+'&numeroProcesso='+document.getElementById('numeroProcesso').value+'&PosicaoPaginaAtual=' + posicao;
		...
		corpoTabela +='<a href=\"Pendencia?PaginaAtual=6&amp;pendencia=' + 'JsoNid' + '&amp;CodigoPendencia='+ 'JsoNhash' +'&amp;fluxo=4\">';
