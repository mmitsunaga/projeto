<script type="text/javascript">
	function buscaDados(posicao, tamanho) {
		...
		url = 'PendenciaJson?AJAX=ajax&PaginaAtual=3&fluxo=10&Id_PendenciaTipo='+document.getElementById('Id_PendenciaTipo').value+'&numeroProcesso='+document.getElementById('numeroProcesso').value+'&PosicaoPaginaAtual=' + posicao;
		...
		corpoTabela +='<td>';
		corpoTabela +='<a href=\"Pendencia?PaginaAtual=7&amp;pendencia=' + 'JsoNid' + '&amp;CodigoPendencia='+ 'JsoNhash' +'&amp;fluxo=3&amp;op=PrazoDecorrido\">';
