<script type="text/javascript">
	function buscaDados(posicao, tamanho) {
		...
		url = 'PendenciaJson?AJAX=ajax&PaginaAtual=3&fluxo=14&dataInicialFim='+document.getElementById('dataInicialFim').value+'&dataFinalFim='+document.getElementById('dataFinalFim').value +'&nomeBusca='+document.getElementById('nomeBusca').value+ '&PosicaoPaginaAtual=' + posicao;
