<script type="text/javascript">  
	function buscaDados(posicao, tamanho) {
		...
		corpoTabela +='<td class="colunaMinima"><a href="PendenciaResponsavel?PaginaAtual=4&amp;pendencia=' + 'JsoNid' + '&amp;CodigoPendencia=' + 'JsoNhash' + '"><img src="imagens/22x22/btn_encaminhar.png" alt="Distribuir" title="Efetuar troca de respons&Aacute;vel" /></a></td>';            	
