...
<body>
  <div id="divCorpo" class="divCorpo" >
  	<div class="area"><h2>&raquo; Detalhes da Publicação (<%=Pendenciadt.getId()%>)</h2></div>
							...
							<table id="tabelaAndamentos" class="Tabela">
								<thead>
									<tr>
										...
										<th class="colunaMinima">Indexar</th>
										<th class="colunaMinima">Bloquear</th>
									</tr>
								</thead>
										...
										<tr>
											...
											<td class="colunaMinima">
												<img src="imagens/22x22/ico_editar.png" alt="Abrir Arquivo Publicação" title="Abrir Arquivo Publicação"
													onclick="window.open('PendenciaPublicacao?PaginaAtual=<%=Configuracao.Curinga8%>&amp;Id_Arquivo=<%=obj.getId()%>&amp;PassoBusca=2','_blank','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,copyhistory=no,resizable=yes,fullscreen=yes')">
											</td>
											<td class="colunaMinima">
												<a href="PendenciaPublicacao?PaginaAtual=<%=Configuracao.Curinga9%>&amp;Id_Pendencia=<%=Pendenciadt.getId()%>&amp;Id_Arquivo=<%=obj.getId()%>">
													<img src="imagens/22x22/ex_ico_solucionar.png" alt="Indexar arquivo manual no Elastic Search" title="Indexar arquivo manual no Elastic Search" />
												</a>
											</td>
											<td class="colunaMinima">
												<a href="PendenciaPublicacao?PaginaAtual=<%=Configuracao.Cancelar%>&amp;Id_Pendencia=<%=Pendenciadt.getId()%>&amp;Id_Arquivo=<%=obj.getId()%>">
													<img src="imagens/22x22/ico_fecharG.png" alt="Bloquear arquivo manual" title="Bloquear arquivo manual" />
												</a>
											</td>
