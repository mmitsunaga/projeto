		...
		<div id="divCorpo" class="divCorpo" >
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset class="formEdicao" id="fieldsetMesFechado"> 
					...
					<label for="Aviso" style="float:left;color:red;"><small>ATENÇÃO: este relatório não mostra produtividade do mês atual. Selecione exclusivamente meses anteriores.</small></label><br>  
				</fieldset>
				...
				<fieldset class="formEdicao"  id="fieldsetGrupo"> 
				    ...
				    <label for="Aviso" style="float:left;color:red;"><small>ATENÇÃO: este relatório não gera estatística para ASSESSORES e ASSISTENTES DE GABINETE.</small></label><br>
				</fieldset>
