		...
		<div id="divCorpo" class="divCorpo" >
	    	...
	    	<form action="AudienciaFisico" method="post" name="Formulario" id="Formulario">
				...
				<fieldset id="VisualizaDados" class="VisualizaDados">
					...
					<span><%=AudienciaFisicodt.getProcessoNumero()%></span>
					<br />					
					
					<div> Data da Audiência </div>
					<span><%=AudienciaFisicodt.getDataAgendada()%></span>
					<br />
					
					<div> Tipo Audiência</div>
					<span><%=AudienciaFisicodt.getAudienciaTipo()%></span>
					<br />
					
					<div> Cargo</div>
					<span><%=AudienciaFisicodt.getAudienciaProcessoDt().getServentiaCargo()%></span>
					<br />
