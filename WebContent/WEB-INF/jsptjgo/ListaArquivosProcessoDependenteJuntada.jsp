...
<script language="javascript" type="text/javascript" >
	...
	$(document).ready(function(){
		...
		$("input.chk0").click(function(){  				
				$("#a"+$(this).val() + " > li > input.chk1").attr("checked",$(this).attr("checked"));
				$("#a"+$(this).val() + " > li > ul > li > input.chk2").attr("checked",$(this).attr("checked"));
				somar();
			});
					
		$("input.chk1").click(function(){  				
				$("#a"+$(this).val() + " > li > input.chk2").attr("checked",$(this).attr("checked"));
				somar();
			});
...
<body>
  <div  id="divCorpo" class="divCorpo">
 	...
 	<div class="area"><h2>&raquo; Encaminhando Documento</h2></div>
	 		...
	 		<div align="center"> 
			  <p class="style1">Selecione os Arquivos que Deverão ser Emcaminhado no Ofício ao Processo Principal</p>
			</div>
			...
			<br />
			<div align="center">
				<button type="submit" name="operacao" value="GerarPDF" onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.Novo)%>'); AlterarValue('fluxo','3')" >
