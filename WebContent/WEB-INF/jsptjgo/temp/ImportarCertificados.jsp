...
<title>Importa&ccedil;&atilde;o Certificados</title>
...
<div id="divCorpo" class="divCorpo" >
	<div align="right">
    	<form action="CertificadoImportar"  method="post" name="Formulario2" id="Formulario2">
	...
	<div id="divEditar" class="divEditar">
		<fieldset> <legend> Situa&ccedil;&atilde;o da Importa&ccedil;&atilde;o </legend>
	    	<label>Qtd Certificados: <label> <%=request.getAttribute("QtdTotal")%><br />
			...
			<form action="CertificadoImportar"  method="post" name="Formulario1" id="Formulario1" >	       	
  	...
  	<div class="Centralizado">
        ...
        <form action="CertificadoImportar"  method="post" name="Formulario3" id="Formulario3" >
