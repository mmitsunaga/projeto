...
<body>
  <div id="divCorpo" class="divCorpo" >
	...
	<form action="Pendencia" method="post" name="Formulario" id="Formulario">
		...
		<button type="submit" name="operacao" value="MovimentarProcessoPendenciaPrazoDecorrido" onclick="AlterarValue('PaginaAtual', <%=Configuracao.Localizar%>);">
		...
		<button type="submit" name="operacao" value="VistarPendenciaPrazoDecorrido" onclick="AlterarValue('PaginaAtual', <%=Configuracao.Curinga6%>); AlterarValue('fluxo','3');">
