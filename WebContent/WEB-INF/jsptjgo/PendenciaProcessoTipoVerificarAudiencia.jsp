...
<div  id="divCorpo" class="divCorpo">
	...
	<form action="Pendencia" method="post" id="Formulario">
			<div class="area"><h2>&raquo; Resolver Pend&ecirc;ncia Processo Marcar Audiência</h2></div>
			...
			<div id="divEditar" class="divEditar">			
				...
				<div id="dados">
					...
					<%if (Pendenciadt.getId_Processo() != null && !Pendenciadt.getId_Processo().equals("")){%>
						...
						<br />
						<label class="formEdicaoLabel" style="margin-top:0;">Movimenta&ccedil;&atilde;o:</label><br><%=Pendenciadt.getMovimentacao()%><br />
					<%}%>
					...
					<div id="divBotoesCentralizados" class="divBotoesCentralizados">
						...
						<button type="submit" name="operacao" value="ConfirmarMarcandoAudiencia" onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.Salvar)%>')">
						...
						<%if (request.getAttribute("habilitarResponder") != null && request.getAttribute("habilitarResponder").toString().equalsIgnoreCase("true")){ %> 
							<button type="submit" name="operacao" value="FinalizarMarcandoAudiencia" onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.SalvarResultado)%>')">
							<!-- <img src="imagens/22x22/ico_sucesso.png" alt="Finalizar e Marcar Audiência" /> -->
									Finalizar Marcando Audiência
							</button>
						<% } else {%>
							<button type="submit" disabled="false" name="operacao" value="FinalizarMarcandoAudiencia" onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.SalvarResultado)%>')">
								<!-- <img src="imagens/22x22/ico_sucesso.png" alt="Finalizar e Marcar Audiência" /> -->
									Finalizar Marcando Audiência
							</button>
						<%} %>
