...
<title>|<%=request.getAttribute("tempPrograma")%>| Vistar Tarefa</title>
...
<div class="area"><h2>&raquo; Vistar Tarefa</h2></div>
	...
	<div id="divPortaBotoes" class="divPortaBotoes">
		<input id="imgLocalizar" alt="Localizar" class="imgLocalizar" title="Localizar - Localiza um registro no banco" name="imaLocalizar" type="image"  src="./imagens/imgLocalizar.png"  onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.Novo)%>')" />
		<input id="imgSolucionar" alt="Solucionar" class="imgLocalizar" title="Vistar Tarefa" name="imaLocalizar" type="image"  src="./imagens/imgSalvar.png"  onclick="AlterarValue('PaginaAtual','<%=String.valueOf(Configuracao.Salvar)%>')" />
	</div>
	...
	<div id="divEditar" class="divEditar">
		<fieldset id="VisualizaDados" class="VisualizaDados">
			...
			<div id="Editor" class="Editor" style="overflow:auto; height:150px; text-align:left; width:85%; border:grey 2px solid; background-color:white;">
				<%=Tarefadt.getDescricao()%>
			</div>
			<br/><br/>
			
			<div valign="center"><label for="Resposta">Resposta:</label><br></div>
			<div id="Editor" class="Editor" style="overflow:auto; height:150px; text-align:left; width:85%; border:grey 2px solid; background-color:white;">
