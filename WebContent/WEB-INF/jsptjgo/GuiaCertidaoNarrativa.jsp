...
<head>
	...
	<title>TJGO/Projudi - Formulário de Guia de Certidão Narrativa</title>
	<style type="text/css">
...
<body>
	...
	<div id="divCorpo" class="divCorpo">	  	
		<div class="area"><h2>&raquo; |<%=request.getAttribute("tempPrograma")%>| Formulário de Guia</h2></div>
		  ...
		  <form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="GuiaCertidaoNarrativa" id="GuiaCertidaoNarrativa">
			...
			<div id="divEditar" class="divEditar">
                <fieldset id="VisualizaDados" class="VisualizaDados">
                	...
                	if( request.getSession().getAttribute("TipoConsulta") != null && request.getSession().getAttribute("TipoConsulta").equals("Publica") ) {
                		%>
                		<span><%=processoDt.getProcessoNumero()%></span/>
                		<%
                	}
                	else {
                		%>
				...
				<fieldset class="formEdicao"> 
                	...
                	<div class="col45 clear">
						...
						<input class="formEdicaoInput" name="Nome" id="Nome" type="text" size="60" maxlength="255" value="<%=(guiaCertidaoGeralDt.getNome()!=null)?guiaCertidaoGeralDt.getNome():""%>">
					</div>
					
					<div class="col20">
		  			    <label class="formEdicaoLabel" for="Cpf">*CPF/CNPJ</label><br>
		  			    <input class="formEdicaoInput" name="Cpf" id="Cpf" type="text" size="20" onkeypress="return DigitarSoNumero(this, event)" onkeyup=" autoTab(this,20)" value="<%=(guiaCertidaoGeralDt.getCpf()!=null)?guiaCertidaoGeralDt.getCpf():""%>">
	  			    </div>
                </fieldset>

			</div>				
				<div id="divBotoesCentralizados" class="divBotoesCentralizados">
                    <button name="imgPreviaCalculo" value="Prévia do Cálculo" id="botaoPrevia" onclick="VerificarCampos();AlterarValue('PaginaAtual','<%=Configuracao.Curinga6%>');AlterarValue('PassoEditar','<%=Configuracao.Curinga8%>');">
