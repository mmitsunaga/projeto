				...
				<div id="divEditar" class="divEditar">
					<fieldset class="formEdicao"> 
					    ...
					    <fieldset>					    	
					    	...
					    	<input class="formEdicaoInput" name="ProcessoNumeroFisico" id="ProcessoNumeroFisico"  type="text" size="30" maxlength="25" value="<%=ProcessoCadastroDt.getProcessoNumeroFisico()%>" onkeyup="mascara(this, '#######.##.####.#.##.####'); autoTab(this,25)" onkeypress="return DigitarNumeroProcesso(this, event)" />
