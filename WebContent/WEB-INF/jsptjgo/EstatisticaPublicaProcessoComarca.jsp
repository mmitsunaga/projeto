...
<html>
	...
	<body class="fundo">		
			...
			<!-- INÍCIO DA ESTATISTICA GERAL DE PROCESSOS DO ESTADO -->
			<div id="divTabela" class="divTabela"> 
				<table id="Tabela" class="Tabela" width="50%">
					<thead>
						<tr>
							<th colspan="6">ESTATISTICA GERAL DE PROCESSOS DO ESTADO</th>
						</tr>
						<tr>
							<th width="5%">&nbsp;</th>
							<th width="20%">&nbsp;</th>
			...
			<!-- FIM DA ESTATISTICA GERAL DE PROCESSOS DO ESTADO -->
			...
			<!-- INÍCIO DA ESTATISTICA GERAL DE PROCESSOS POR COMARCA DO ESTADO -->
			<div id="divTabela" class="divTabela"> 
				<table id="Tabela" class="Tabela" width="50%">
					<thead>
						<tr>
							<th colspan="6">ESTATISTICA GERAL DE PROCESSOS POR COMARCA DO ESTADO</th>
						</tr>
						<tr>
							<th width="5%">&nbsp;</th>
							<th width="20%">&nbsp;</th>
	  				...
	  				if(liTemp!=null){ 
		  				for(int i = 0 ; i< liTemp.size();i++) {
		  					...
		  					<tr class="TabelaLinha<%=(boLinha?1:2)%>">
								<th colspan="6">
									<a href="EstatisticaPublica?PassoBusca=2&EstatisticaPublicaTipoConsulta=1&Id_Comarca=<%= objTemp.get("Id_Comarca")%>">
										<%= objTemp.get("Comarca")%>
									</a>
								</th>
							</tr>
			...
			<!-- FIM DA ESTATISTICA GERAL DE PROCESSOS POR COMARCA DO ESTADO -->
