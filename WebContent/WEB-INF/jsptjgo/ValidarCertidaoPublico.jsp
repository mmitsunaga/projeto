	...
	<%@ include file="/CabecalhoPublico.html" %>   
	  <div  id="divCorpo" class="divCorpo">
		...
		<div id="divLocalizar" class="divLocalizar" >
			<form method="post" action="CertidaoPublica" id="Formulario" target=""> 
			    ...
			    <fieldset id="formLocalizar" class="formLocalizar"> 
			   	...
			   	<fieldset class="formEdicao"> 
				    	<legend class="formEdicaoLegenda">
				    		Observa&ccedil;&otilde;es</legend>
													
							
							<p>
								Ao Digitar o código de validação será mostrada a Certidão original, gravada no sistema, para conferência de sua autenticidade. Não será gerado "Confirmação de autenticidade de certidões".</p>							
					</fieldset>		
