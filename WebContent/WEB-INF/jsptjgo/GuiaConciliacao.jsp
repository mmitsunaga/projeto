...
<head>
	...
	<title>TJGO/Projudi - Formulário de Guia de Conciliação</title>
	<style type="text/css">
...
<body>
	...
	<div id="divCorpo" class="divCorpo">	  	
		<div class="area"><h2>&raquo; |<%=request.getAttribute("tempPrograma")%>| Formulário de Guia de Conciliação</h2></div>
		<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="GuiaConciliacao" id="GuiaConciliacao">
			...
			<div id="divEditar" class="divEditar">
				...
				<fieldset id="VisualizaDados" class="VisualizaDados">
					...
					<span>
						<input type="text" name="valorConciliacao" id="valorConciliacao" value="<%=GuiaEmissaoDt.getValorConciliacao()%>" maxlength="25" onkeyup="MascaraValor(this);autoTab(this,25)" onkeypress="return DigitarSoNumero(this, event)" size="80" />
					</span>
                </fieldset>
