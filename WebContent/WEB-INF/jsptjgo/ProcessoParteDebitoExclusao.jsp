	...
	<div id="divCorpo" class="divCorpo">
		...
		<form action="ProcessoParteDebito" method="post" name="Formulario" id="Formulario">
			...
			<fieldset id="VisualizaDados" class="VisualizaDados"> 
				<legend>Exclusão de Débito </legend>
				
				<div>Processo</div> 
				<span>
				<b><%=Funcoes.formataNumeroCompletoProcesso(ProcessoParteDebitodt.getProcessoNumeroCompleto())%></b>				
				</span>
				<br />
				
				<div>Parte</div> 
				<span><%=ProcessoParteDebitodt.getNome()%></span>
				<br />
				
				<div>Débito</div>  
				<span><%=ProcessoParteDebitodt.getProcessoDebito()%></span>
				<br />
				<br />
