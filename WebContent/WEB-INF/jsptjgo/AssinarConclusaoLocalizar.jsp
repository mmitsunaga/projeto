			...
			<form action="<%=request.getAttribute("tempRetorno")%>" method="post" name="Formulario" id="Formulario">			
				...
				<div id="divTabela" class="divTabela" > 
					...
					<div id="divBotoesCentralizados" class="divBotoesCentralizados">
						...
						<input name="imgDescartar" type="submit" value="Voltar para pré-análise" onclick="AlterarAction('Formulario','AssinarConclusao');AlterarValue('PaginaAtual','<%=Configuracao.SalvarResultado%>');AlterarValue('acaoSalvar','<%=Configuracao.Curinga7%>');" />						
					</div>
